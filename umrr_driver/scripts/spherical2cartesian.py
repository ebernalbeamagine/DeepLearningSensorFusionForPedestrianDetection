...
class CartesianConverter:
    def __init__(self):
        ...
        rospy.Subscriber("/radar/filtered_data", pc2.PointCloud2, self.pc_callback)
    ...
    def pc_callback(self, data):
        ...
        for single_point in cloud_points:
            ...
            points.append([x, y, z, single_point[speed_rad_index], single_point[rcs_index], snr,single_point[pow_index]])
