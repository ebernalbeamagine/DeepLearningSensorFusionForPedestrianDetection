...
A network model called **model151_nint_last.pt** has been generated by trainning the network with not interpoated lidar and radar images.  This model allow to run the sensor fusion process in real time. By real time we mean that the ROS package is able to process the radar, lidar and RGB snesor at a frequency of 18, 6 and 10 Hertz respectivelly. The Figure 2 shows the schematic diagram of the ROS package.
...
<div style="text-align: center;">
 ...
 <em> <b>Figure 2.</b> The roslaunch ROS nodes and topics for the real time application. </em>
</p>
