...
A network model called **model151_nint_last.pt** has been generated by trainning the network with not interpoated lidar and radar images.  This model allow to run the sensor fusion process in real time. By real time we mean that the 


<p align="center">
<div style="text-align: center;">
   <img alt="img-name" src="https://github.com/ebernalbeamagine/DeepLearningSensorFusionForPedestrianDetection/blob/master/documents/ros_real_time.png" width="380" height="260" border="10">
 <br>
</div>
 <em> <b>Figure.</b> The roslaunch ROS nodes and topics for the real time application </em>
</p>
