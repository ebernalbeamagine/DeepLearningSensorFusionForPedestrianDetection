...
//! @brief  Experimental function for prototype 2022021800, enables or disables the duplicate of RGB camera
//!         streaming, only works when the streaming protocol is gstreamer
//! @param  device The device to execute the function
//! @param  enabled Boolean to disable/enable the feature
//! @return 0 if OK otherwise Error, check error definition
