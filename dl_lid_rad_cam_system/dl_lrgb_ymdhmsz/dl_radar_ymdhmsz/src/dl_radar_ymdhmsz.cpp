...
void  RadarCallback(const  sensor_msgs::PointCloud2ConstPtr& radar_msg_){ 
   ...
   if(flag_radar==true){    
      if( pcl::io::savePCDFileASCII ("/home/acp/catkin_ws/src/lrgb_ymdhmsz/Radar/"  + std::to_string(year)+ md + "_" + hms + "_" + ms+".pcd", *temp_cloud)==-1){  
...
int main(int argc, char** argv){
   ...
   system("exec rm -r /home/acp/catkin_ws/src/dl_pedestrian_detection/dl_lrgb_ymdhmsz/Radar/*");
